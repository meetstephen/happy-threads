      ...
      <div className="container-luxe flex flex-col items-center gap-6 text-center md:flex-row md:justify-between md:text-left">
        ...
        <div className="flex items-center gap-3">
          ...
          <button
            ...
            aria-label="Atelier — manage collection"
            title="Manage collection (atelier only)"
            className="grid h-9 w-9 place-items-center rounded-full border border-ink-800/15 text-ink-800/40 transition-colors hover:border-bronze-500 hover:text-bronze-500 dark:border-cream-100/15 dark:text-cream-100/40"
          >
            <KeyRound size={13} />
          </button>
        </div>
