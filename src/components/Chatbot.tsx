      ...
      <AnimatePresence>
        {open && (
          <motion.aside
            ...
            className="fixed bottom-[calc(5.5rem+env(safe-area-inset-bottom,0px))] left-4 right-4 z-40 flex h-[min(640px,78vh)] max-w-md flex-col overflow-hidden rounded-3xl border border-ink-800/10 bg-cream-100 shadow-luxe md:bottom-24 sm:left-6 sm:right-auto sm:w-[400px] dark:border-cream-100/10 dark:bg-ink-800"
          >
            {/* Header */}
