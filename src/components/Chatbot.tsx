  ...
  return (
    <>
      ...
      <button
        ...
        className={`fixed bottom-20 left-4 z-30 flex items-center gap-2 rounded-full bg-ink-800 px-3.5 py-2.5 text-xs font-medium text-cream-100 shadow-luxe transition-all duration-500 hover:bg-bronze-500 md:bottom-6 md:left-6 sm:gap-2.5 sm:px-5 sm:py-3.5 sm:text-sm dark:bg-cream-100 dark:text-ink-900 dark:hover:bg-bronze-400 ${
      ...
      <AnimatePresence>
        {open && (
          <motion.aside
            ...
            className="fixed bottom-[7rem] left-4 right-4 z-40 flex h-[min(640px,78vh)] max-w-md flex-col overflow-hidden rounded-3xl border border-ink-800/10 bg-cream-100 shadow-luxe md:bottom-24 md:left-6 sm:right-auto sm:w-[400px] dark:border-cream-100/10 dark:bg-ink-800"
          >
            {/* Header */}
