      ...
      <div className="container-luxe flex h-20 items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <button
            ...
            className="grid h-11 w-11 place-items-center rounded-full border border-ink-800/15 transition-colors hover:border-bronze-500 hover:text-bronze-500 dark:border-cream-100/20"
          >
          ...
          <a
            ...
            className="relative grid h-11 w-11 place-items-center rounded-full border border-ink-800/15 transition-colors hover:border-bronze-500 hover:text-bronze-500 dark:border-cream-100/20"
          >
            <Heart size={16} />
            {favorites.length > 0 && (
          ...
          <button
            ...
            className="grid h-11 w-11 place-items-center rounded-full border border-ink-800/15 transition-colors hover:border-bronze-500 hover:text-bronze-500 md:hidden dark:border-cream-100/20"
          >
